...
public class AtlasObjectIdToIdConverter implements AtlasFormatAdapter<AtlasObjectId, Id> {
    ...
    @Override
    public Id convert(final AtlasObjectId source) throws AtlasBaseException {
        Id ref = new Id(source.getGuid(), 0 , source.getTypeName(), Id.EntityState.ACTIVE.name());
        return ref;
    }

    @Override
    public Class getSourceType() {
        return AtlasObjectId.class;
    }
