...
public class OptimizationContext {
    ...
    public String addFunctionDefinition(VarDecl decl, GroovyExpression body) {
        String functionName = getUniqueFunctionName();
        List<VarDecl> decls = (decl == null) ? Collections.<VarDecl>emptyList() : Collections.singletonList(decl);
