...
public abstract class AtlasDeleteHandlerV1Test {
    ...
    public void testDisconnectMapReferenceFromClassType() throws Exception {
        ...
        mapOwnerInstance.setAttribute("map", Collections.singletonMap("value1", mapValueInstance.getAtlasObjectId()));
        mapOwnerInstance.setAttribute("biMap", Collections.singletonMap("value1", mapValueInstance.getAtlasObjectId()));
        // Set biMapOwner reverse reference on MapValue.
        mapValueInstance.setAttribute("biMapOwner", mapOwnerInstance.getAtlasObjectId());
    ...
    public void testLowerBoundsIgnoredWhenDeletingCompositeEntitesOwnedByMap() throws Exception {
        ...
        mapValueReferenceContainer.setAttribute("requiredMap", Collections.singletonMap("value1", mapValueReferencer.getAtlasObjectId()));
